...
const Banner = () => {
  ...
  return (
    <div className=" container-fluid bg-gradient-to-r from-green-300 via-white to-pink-300  h-auto ">
      <div className="  px-10   md:px-20 m-auto py-10  md:py-20 flex items-center flex-wrap md:flex-nowrap gap-10  md:gap-0">
        ...
        <div className=" h-[300px] md:h-[550px] ml-auto">
          <img
            className="w-auto h-auto max-w-auto md:max-w-[550px] max-h-full rounded"
